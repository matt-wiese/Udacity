window.onload = function () {
  // Variables
  const url =
    "https://raw.githubusercontent.com/paulbgomez/JavaScript-OOP/main/assets/json/dino.json";
  let dataJSON; // Dino[];
  let dataForm = {};
  ...
  function initApp() {
    ...
    let fullArray = valueMiddleArray(shuffleArray(listaDino), human);
        ...
        switch (comparisonMethod) {
          case 0:
            tilesHTML +=
              ...
              fullArray[i].species.toLowerCase() +
              '.png" />';
